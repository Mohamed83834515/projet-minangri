...
import { type NavMode, useLayout } from '@/stores/others/layout-store'
import {
  CHART_COLORS,
  type ChartColorKey,
  HEADER_COLORS,
    ...
    <TooltipProvider delayDuration={300}>
      <Sheet>
        ...
        >
          ...
          <div className='scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent flex-1 space-y-7 overflow-y-auto px-6 py-6'>
            <NavModeConfig />
            <HeaderColorConfig />
            <ThemeConfig />
            <ColorConfig />
        ...
        {options.map(({ value, label, icon: Icon, description }) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <div className='text-xs leading-none font-semibold'>{label}</div>
...
function ColorSwatchRow({
  ...
  return (
    <div className='space-y-2'>
      {/* Row header: label + dot preview + reset */}
      <div className='flex items-center justify-between'>
  ...
  return (
    <div>
      <SectionTitle
        ...
        onReset={() => { resetColor(); resetColor2() }}
