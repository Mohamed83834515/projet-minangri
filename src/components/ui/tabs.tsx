...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      style={style}                    
      className={cn(
        // On retire data-[state=active]:bg-background et on le remplace
        // par une inline var avec fallback sur bg-background
        ...
        // data-[state=active]:bg-[var(--tab-active-bg,hsl(var(--background)))]
        "data-[state=active]:bg-[var(--tab-active-bg,hsl(var(--background)))]",   
        "data-[state=active]:text-[var(--tab-active-color,hsl(var(--foreground)))]", 
        // dark mode : si pas de couleur custom, fallback sur bg input/30
        "dark:data-[state=active]:bg-[var(--tab-active-bg,hsl(var(--input)/0.3))]",
        className
      )}
      {...props}
    />
