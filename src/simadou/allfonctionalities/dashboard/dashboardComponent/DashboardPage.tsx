...
const FICTIVE_ACTIVITES: Ptba[] = [
  {
    ...
    code_activite_ptba: 'ACT001',
    intitule_activite_ptba: 'Formation des agriculteurs',
    chronogramme: '2024',
    statut_activite: 'En cours',
    version_ptba: 1,
    type_activite: 'Formation',
    composante_ptba: 'Composante A',
    taux_avancement_technique: 75,
    taux_indicateurs: 80,
    taux_decaissement: 60,
  },
  {
    id_ptba: 2,
    localites_ptba: [],
    partenaire_conserne_ptba: [],
    code_activite_ptba: 'ACT002',
    intitule_activite_ptba: 'Construction de pistes rurales',
    chronogramme: '2024',
    statut_activite: 'En cours',
    version_ptba: 1,
    type_activite: 'Infrastructure',
    composante_ptba: 'Composante B',
    taux_avancement_technique: 45,
    taux_indicateurs: 50,
    taux_decaissement: 40,
  },
  {
    id_ptba: 3,
    localites_ptba: [],
    partenaire_conserne_ptba: [],
    code_activite_ptba: 'ACT003',
    intitule_activite_ptba: "Distribution d'intrants",
    chronogramme: '2024',
    statut_activite: 'Terminé',
    version_ptba: 2,
    type_activite: 'Logistique',
    composante_ptba: 'Composante A',
    taux_avancement_technique: 100,
    taux_indicateurs: 95,
    taux_decaissement: 90,
  },
  {
    id_ptba: 4,
    localites_ptba: [],
    partenaire_conserne_ptba: [],
    code_activite_ptba: 'ACT004',
    intitule_activite_ptba: 'Suivi-évaluation',
    chronogramme: '2025',
    statut_activite: 'Planifié',
    version_ptba: 2,
    type_activite: 'Management',
    composante_ptba: 'Composante C',
    taux_avancement_technique: 10,
    taux_indicateurs: 15,
    taux_decaissement: 5,
  },
]
...
const FICTIVE_TACHES: TacheActivitePtba[] = [
  {
    id_groupe_tache: 1,
    intutile_tache_gt: 'Planification',
    proportion_gt: '10%',
    code_tache_gt: 'T001',
    date_debut_gt: '2024-01-01',
    date_fin_gt: '2024-01-31',
    date_reelle_gt: '2024-01-30',
    n_lot_gt: 101,
    valider_gt: 'Validé',
    livrable_gt: 'Plan',
    id_activite: 1,
  ...
  {
    id_groupe_tache: 2,
    intutile_tache_gt: 'Exécution terrain',
    proportion_gt: '50%',
    code_tache_gt: 'T002',
    date_debut_gt: '2024-02-01',
    date_fin_gt: '2024-06-30',
    date_reelle_gt: '',
    n_lot_gt: 102,
    valider_gt: 'En cours',
    livrable_gt: 'Rapport',
  ...
  {
    id_groupe_tache: 3,
    intutile_tache_gt: 'Rapport final',
    proportion_gt: '40%',
    code_tache_gt: 'T003',
    date_debut_gt: '2024-07-01',
    date_fin_gt: '2024-08-31',
    date_reelle_gt: '',
    n_lot_gt: 103,
    valider_gt: 'En cours',
    livrable_gt: 'Rapport',
  ...
  {
    id_groupe_tache: 4,
    intutile_tache_gt: 'Étude de sol',
    proportion_gt: '30%',
    code_tache_gt: 'T004',
    date_debut_gt: '2024-03-01',
    date_fin_gt: '2024-04-30',
    date_reelle_gt: '',
    n_lot_gt: 201,
    valider_gt: 'Validé',
    livrable_gt: 'Étude',
  ...
  {
    id_groupe_tache: 5,
    intutile_tache_gt: 'Construction',
    proportion_gt: '70%',
    code_tache_gt: 'T005',
    date_debut_gt: '2024-05-01',
    date_fin_gt: '2024-12-31',
    date_reelle_gt: '',
    n_lot_gt: 202,
    valider_gt: 'En cours',
    livrable_gt: 'Infrastructure',
    id_activite: 2,
    observation_gt: '',
    id_personnel_gt: 4,
    responsable_gt: 4,
...
const FICTIVE_PLANS_SITES: PlanSite[] = [
  {
    id_ds: 101,
    code_ds: 'DS001',
    intutile_ds: "Direction de l'Agriculture",
    niveau_ds: 1,
    parent_ds: 0,
    code_relai_ds: 'REL001',
  },
  {
    id_ds: 102,
    code_ds: 'DS002',
    intutile_ds: 'Direction des Infrastructures',
    niveau_ds: 1,
    parent_ds: 0,
    code_relai_ds: 'REL002',
  },
  {
    id_ds: 103,
    code_ds: 'DS003',
    intutile_ds: 'Direction de la Formation',
    niveau_ds: 1,
    parent_ds: 0,
    code_relai_ds: 'REL003',
  },
]
...
const FICTIVE_DECAISSEMENTS = [
  {
    bailleur: 'BAD',
    valeur_decaissement_ptba: 150000,
    montant_prevu_ptba: 200000,
    date_decaissement_ptba: '2024-01-15',
    id_ptba: { id_programme: 1 },
  },
  {
    bailleur: 'BM',
    valeur_decaissement_ptba: 250000,
    montant_prevu_ptba: 300000,
    date_decaissement_ptba: '2024-02-20',
    id_ptba: { id_programme: 1 },
  },
  {
    bailleur: 'UE',
    valeur_decaissement_ptba: 100000,
    montant_prevu_ptba: 150000,
    date_decaissement_ptba: '2024-03-10',
    id_ptba: { id_programme: 1 },
  },
  {
    bailleur: 'BAD',
    valeur_decaissement_ptba: 80000,
    montant_prevu_ptba: 100000,
    date_decaissement_ptba: '2024-04-05',
    id_ptba: { id_programme: 1 },
  },
]
...
const DashboardPage: React.FC = () => {
  ...
  const composanteData: ExecutionComposante[] = useMemo(() => {
    ...
    const composanteMap: Record<
      string,
      { avt: number; ind: number; dec: number; total: number }
    > = {}

    acts.forEach((a) => {
      const comp: string =
        (a as any).composante_ptba ?? `Composante ${a.id_ptba ?? '—'}`
      ...
      composanteMap[comp].avt += Number(
        (a as any).taux_avancement_technique ?? 0
      )
  ...
  const realisationCiblesData = useMemo(() => {
    const anneeMap: Record<
      string,
      { realisation: number; cibles: number; count: number }
    > = {}
    versions.forEach((v) => {
    ...
    return Object.entries(serviceMap)
      .map(([sid, d]) => {
        ...
        if (type === 'ugls') {
          ...
          const ugl = FICTIVE_UGLS.find(
            (u) => u.id_ugl === Number(sid) || u.code_ugl === sid
          )
        ...
        return {
          ...
          tachesTotal: d.total,
          pourcentage:
            d.total > 0 ? Math.round((d.terminees / d.total) * 100) : 0,
        }
      })
  ...
  const avancementTaches = useMemo(
    () => buildServiceData(anneeTaches, 'services').slice(0, 10),
    [taches, activites, versions, plansSites, anneeTaches]
  )

  // Pour les indicateurs (UGL)
  const avancementIndicateurs = useMemo(
    () => buildServiceData(anneeIndicateurs, 'ugls').slice(0, 8),
  ...
  const decaissFiltres = useMemo(
    () =>
      decaissements.filter((d: any) => d.id_ptba?.id_programme === idProgramme),
  ...
  const decaissementBailleur = useMemo(() => {
    ...
    decaissFiltres.forEach((d: any) => {
      ...
      map[b].prevu += Number(
        d.montant_prevu_ptba ?? d.valeur_decaissement_ptba ?? 0
      )
    })
  ...
  const { data: projectsPerType = [] } = useCountProjectsPerType()
  ...
  const ptbaProgrammeStats = useMemo(() => {
    const versionIds = versions
      ...
      .map((v) => v.id_version_ptba)
    const activitesAnnee = activites.filter((a) =>
      versionIds.includes(a.version_ptba)
    )
    ...
    const tauxDecaissement = Math.round(
      (montantTotalDecaisse / montantTotalPrevu) * 100
    )

    // Activités réalisées = taux_avancement_technique >= 100
    const activitesRealisees = activitesAnnee.filter(
      (a) =>
        (a as any).taux_avancement_technique === 100 ||
        a.statut_activite?.toLowerCase() === 'terminé'
    ).length
    const totalActivites = activitesAnnee.length || 48 // 48 fictif si vide
    const pourcentageRealisation =
      totalActivites > 0
        ? Math.round((activitesRealisees / totalActivites) * 100)
        : 85
  ...
  const ptbaDepartementStats = useMemo(() => {
    ...
    const activitesRealisees = activitesAnnee.filter(
      (a) => (a as any).taux_avancement_technique === 100
    ).length
      ...
      <div className='grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4'>
        ...
        <StatCard
          ...
          rows={[
            ...
            {
              label: 'Nombre projet critique',
              value: projetProgrammeStats.critiques,
              suffix: `(${projetProgrammeStats.pourcentageCritique}%)`,
              valueColor: 'red',
            },
          ]}
        />
          ...
          rows={[
            {
              ...
              value: ptbaProgrammeStats.montantPrevu.toLocaleString('fr-FR'),
              suffix: 'GNF',
            },
            {
              label: 'Montant Total Décaissé',
              value: ptbaProgrammeStats.montantDecaisse.toLocaleString('fr-FR'),
              suffix: `(${ptbaProgrammeStats.tauxDecaissement}%) GNF`,
              valueColor: 'emerald',
            },
            {
              label: "Nombre Total d'activité réalisée",
              value: ptbaProgrammeStats.activitesRealisees,
              suffix: `(${ptbaProgrammeStats.pourcentageRealisation}%)`,
              valueColor: 'emerald',
            },
          ]}
        ...
        <StatCard
          ...
          rows={[
            {
              label: 'Montant Total Prévu',
              value: ptbaDepartementStats.montantPrevu.toLocaleString('fr-FR'),
              suffix: 'GNF',
            },
            {
              label: 'Montant Total Décaissé',
              value:
                ptbaDepartementStats.montantDecaisse.toLocaleString('fr-FR'),
              suffix: `(${ptbaDepartementStats.tauxDecaissement}%) GNF`,
              valueColor: 'purple',
            },
            {
              label: "Nombre Total d'activité réalisée",
              value: ptbaDepartementStats.activitesRealisees,
              suffix: `(${ptbaDepartementStats.pourcentageRealisation}%)`,
              valueColor: 'purple',
            },
          ]}
