...
export default function RapportContratPerformancePage() {
  ...
  const isLoading =
    contratsLoading || niveauxLoading || cadresLoading || indicateursLoading

  return (
    <RapportPageLayout
      title='Rapport des contrats de performance'
      icon={FileSignature}
    >
      <div className='space-y-4'>
        <div className='flex justify-end'>
          <Select<ContratOption, false>
            ...
            classNamePrefix='contrat-performance'
          />
        </div>
