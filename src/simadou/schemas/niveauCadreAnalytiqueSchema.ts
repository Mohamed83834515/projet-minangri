...
export const niveauCadreAnalytiqueSchema = z.object({
  nombre_nca: z
    .number()
...
export type NiveauCadreAnalytiqueFormData = z.infer<typeof niveauCadreAnalytiqueSchema>;

// Schéma pour la mise à jour (tous les champs optionnels)
export const niveauCadreAnalytiqueUpdateSchema = niveauCadreAnalytiqueSchema.partial();

export type NiveauCadreAnalytiqueUpdateData = z.infer<typeof niveauCadreAnalytiqueUpdateSchema>;
