...
type ActeurDialogType = 'add' | 'edit' | 'delete'

export const buildActeurColumns = (
  setOpen: (dialog: ActeurDialogType | null) => void,
  setCurrentRow: React.Dispatch<React.SetStateAction<Acteur | null>>
): ColumnDef<Acteur>[] => {
  return [
    {
      id: 'code_acteur',
